...
`;
let ProductRecommendationPlugin = class ProductRecommendationPlugin {
};
ProductRecommendationPlugin = __decorate([
...
exports.ProductRecommendationPlugin = ProductRecommendationPlugin;
